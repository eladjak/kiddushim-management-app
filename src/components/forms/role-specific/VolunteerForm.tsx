...
const getInitialState = (initialData: Partial<VolunteerFormData>): VolunteerFormData => ({
  age: initialData.age || "",
...
export const VolunteerForm = ({
  ...
  const { formData, handleInputChange, handleSelectChange, handleSwitchChange, handleCheckboxChange } =
    useFormState<VolunteerFormData>(getInitialState(initialData));
        ...
        <div className="space-y-2">
          ...
          <Select value={formData.recommendToFriends} onValueChange={(value) => handleSelectChange("recommendToFriends", value)}>
            ...
            <SelectContent>
              ...
              <SelectItem value="maybe">אולי, תלוי בחבר</SelectItem>
