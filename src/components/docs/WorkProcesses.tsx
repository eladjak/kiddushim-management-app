...
export const WorkProcesses = () => {
  return (
    <div className="space-y-6 lg:space-y-8 py-4 lg:py-6">
      ...
      <Alert variant="default" className="bg-amber-50 border-amber-200 dark:bg-amber-950/40 dark:border-amber-800">
        <AlertCircle className="h-4 w-4 text-amber-600 dark:text-amber-400" />
        <AlertTitle className="text-right text-amber-800 dark:text-amber-300">הערה חשובה</AlertTitle>
              ...
              <Table>
                ...
                <tbody>
                  <TableRow>
                    ...
                    <TableCell>
                      <Badge className="bg-amber-100 text-amber-800 hover:bg-amber-100 dark:bg-amber-900/40 dark:text-amber-300">דורש אישור</Badge>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell>
                      <Badge className="bg-blue-100 text-blue-800 hover:bg-blue-100 dark:bg-blue-900/40 dark:text-blue-300">קבוע</Badge>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell>
                      <Badge className="bg-green-100 text-green-800 hover:bg-green-100 dark:bg-green-900/40 dark:text-green-300">שוטף</Badge>
                    </TableCell>
                  </TableRow>
                </tbody>
              </Table>
              ...
              <Table>
                ...
                <tbody>
                  <TableRow>
                    ...
                    <TableCell>
                      <Badge className="bg-red-100 text-red-800 hover:bg-red-100 dark:bg-red-900/40 dark:text-red-300">קריטי</Badge>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell>
                      <Badge className="bg-purple-100 text-purple-800 hover:bg-purple-100 dark:bg-purple-900/40 dark:text-purple-300">חודשי</Badge>
                    </TableCell>
                  </TableRow>
                  <TableRow>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white dark:bg-card p-4 rounded-lg shadow-sm">
              ...
              <ul className="space-y-2 text-gray-600 dark:text-gray-400 text-right leading-relaxed text-sm">
